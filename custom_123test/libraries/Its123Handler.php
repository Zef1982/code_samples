...
class Its123Handler
{
     ...
     * @throws Exception
     */
    public function requestAction($action = "/product/request-product", $verifySsl = true, $ca_bundle_path = null, $channel = "default", $productId = null, $accessCode = null, $data = array())
    {
        ...
        $url = $this->protocol . '://' . $this->host . '/' . $this->apiEndpoint  . $action;
