...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5de0f335c4b90\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5de0f335c4b90\Psr\Http\Message\StreamInterface $stream)
    {
