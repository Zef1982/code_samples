 ...
 */
class FulfilledPromise implements \_PhpScoper5de0f335c4b90\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5de0f335c4b90\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
